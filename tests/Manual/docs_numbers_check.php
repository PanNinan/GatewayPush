...
// 每条：[过期字面量, 说明]
$stale = [
    ['467 tests', '旧测试数（现 533）'],
    ['1317 assertions', '旧断言数（现 1555）'],
    ['443 tests', '旧测试数（现 533）'],
    ['1246 assertions', '旧断言数（现 1555）'],
    ['510 tests', '旧测试数（现 533）'],
    ['1431 assertions', '旧断言数（现 1555）'],
    ['519 tests', '旧测试数（现 533）'],
    ['1465 assertions', '旧断言数（现 1555）'],
...
// 正向锚点：必须出现的最新数字
$positive = [
    'README.md'          => ['533 tests', '301 条目'],
    'AGENTS.md'          => ['533 tests', '301 条目'],
    'docs/代码质量工具链说明.md' => ['533 tests', '301 条目'],
];

...
final class CaseSubscribe
{
    ...
    public static function broadcastLoop(Harness $h)
    {
        ...
        $connO->onConnect = function ($con) use ($h, $c) {
            ...
            $con->send($h->encode($h->buildPacket(Message::CMD_AUTH, 'o-auth-1', [
                'uid'       => $c['uid'],
        ...
        $connO->onMessage = function ($con, $raw) use ($h, $c, &$oStep) {
            ...
            switch ($oStep) {
                case 0:
                    ...
                    $oStep = 1;
                    $send('o-sub-1', ['action' => 'subscribe', 'params' => ['topic' => $c['topic']]]);
                ...
                case 1:
                    ...
                    Push::enqueueTopic($c['topic'], ['case' => 'O', 'hello' => 'world'], ['source' => 'e2e']);
                ...
                case 3:
                    ...
                    $oStep = 4;
                    $send('o-unsub-1', ['action' => 'unsubscribe', 'params' => ['topic' => $c['topic']]]);

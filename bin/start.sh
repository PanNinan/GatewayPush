...
#
# ============================================================================
#  GatewayPush 实时数据推送服务 —— Linux/macOS 服务管理脚本
# ============================================================================
#
#  职责边界
#  --------------------------------------------------------------------------
...
# 4. 前置检查
# ---------------------------------------------------------------------------
# PHP 下限（版本 ID，如 80200 = 8.2.0），取自 config/app.php 的 php_min；
# 解析不出来时回落到 8.2.0 —— 宁可报错，也不要因读不到配置而放行旧解释器。
php_min_id() {
...
cmd_help() {
    cat <<'EOF'
GatewayPush 实时数据推送服务 —— Linux 服务管理脚本
